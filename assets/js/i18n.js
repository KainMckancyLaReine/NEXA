...
(function () {
  const DICT = {
    ...
    'hero.sub':    { en:'Deploy AI employees that handle the repetitive work — email, CRM, follow-ups, invoices, scheduling and screening — so your team can focus on growth.', de:'Setze KI-Mitarbeiter ein, die die Routinearbeit erledigen — E-Mail, CRM, Follow-ups, Rechnungen, Terminplanung und Screening — damit sich dein Team auf Wachstum konzentrieren kann.', nl:'Zet AI-medewerkers in die het herhaalwerk doen — e-mail, CRM, opvolging, facturen, planning en screening — zodat jouw team zich op groei kan richten.' },
    ...
    'who.eyebrow': { en:"Who it's for", de:'Für wen', nl:'Voor wie' },
    'who.title':   { en:'Built for teams buried in repetitive work.', de:'Gemacht für Teams, die in Routinearbeit versinken.', nl:'Gebouwd voor teams die verzuipen in herhaalwerk.' },
    'who.sub':     { en:'The more email, admin, follow-ups and scheduling your team handles, the more NEXA gives back.', de:'Je mehr E-Mails, Verwaltung, Follow-ups und Terminplanung Ihr Team erledigt, desto mehr gibt NEXA zurück.', nl:'Hoe meer e-mail, administratie, opvolging en planning je team doet, hoe meer NEXA teruggeeft.' },
    'who.recruit.t':{ en:'Recruitment agencies', de:'Personalvermittler', nl:'Recruitmentbureaus' },
    'who.recruit.d':{ en:'Screen CVs, reach out to candidates, schedule interviews and follow up — around the clock.', de:'Lebensläufe screenen, Kandidaten ansprechen, Interviews planen und nachfassen — rund um die Uhr.', nl:"Cv's screenen, kandidaten benaderen, gesprekken plannen en opvolgen — 24/7." },
    'who.sales.t': { en:'Sales & lead-gen', de:'Vertrieb & Leadgen', nl:'Sales & leadgeneratie' },
    'who.sales.d': { en:'Qualify leads, send follow-ups, book meetings and keep the CRM clean automatically.', de:'Leads qualifizieren, Follow-ups senden, Termine buchen und das CRM automatisch pflegen.', nl:'Leads kwalificeren, follow-ups sturen, afspraken inplannen en je CRM automatisch bijhouden.' },
    'who.agency.t':{ en:'Marketing & agencies', de:'Marketing & Agenturen', nl:'Marketing & bureaus' },
    'who.agency.d':{ en:'Client updates, reporting, planning and project admin — handled without the busywork.', de:'Kundenupdates, Reporting, Planung und Projektverwaltung — ohne den Kleinkram.', nl:'Klantupdates, rapportages, planning en projectadministratie — zonder het uitzoekwerk.' },
    'who.finance.t':{ en:'Accountancy & admin', de:'Buchhaltung & Verwaltung', nl:'Accountancy & administratie' },
    'who.finance.d':{ en:'Document processing, client questions, reminders and invoice flows, on autopilot.', de:'Dokumentenverarbeitung, Kundenfragen, Erinnerungen und Rechnungsläufe automatisch.', nl:'Documentverwerking, klantvragen, herinneringen en factuurstromen op de automatische piloot.' },
    'who.realestate.t':{ en:'Real estate', de:'Immobilien', nl:'Vastgoed' },
    'who.realestate.d':{ en:'Schedule viewings, screen applicants, handle email and chase leads.', de:'Besichtigungen planen, Bewerber prüfen, E-Mails bearbeiten und Leads nachverfolgen.', nl:'Bezichtigingen plannen, kandidaten screenen, e-mail afhandelen en leads opvolgen.' },
    'who.ecom.t':  { en:'E-commerce', de:'E-Commerce', nl:'E-commerce' },
    'who.ecom.d':  { en:'Automate support, returns, order-status replies and review collection.', de:'Support, Retouren, Bestellstatus und Bewertungserfassung automatisieren.', nl:'Support, retouren, orderstatus en reviews verzamelen automatiseren.' },
    'who.saas.t':  { en:'SaaS & startups', de:'SaaS & Startups', nl:'SaaS & startups' },
    ...
    'price.sub':   { en:'Per AI employee. 12-month plan — pay monthly or yearly. No headcount required.', de:'Pro KI-Mitarbeiter. 12-Monats-Abo — monatlich oder jährlich zahlbar. Kein Personalbedarf.', nl:'Per AI-medewerker. 12-maanden abonnement — betaal maandelijks of jaarlijks. Geen extra personeel nodig.' },
    ...
    // -------- pricing hero + lead --------
    'price.leadfull':{ en:'Per AI employee. 12-month term — pay monthly or yearly (yearly saves 20%). No headcount required; the Scale plan includes a free laptop.', de:'Pro KI-Mitarbeiter. 12-Monats-Laufzeit — monatlich oder jährlich zahlbar (jährlich spart 20%). Kein Personalbedarf; der Scale-Tarif enthält einen Gratis-Laptop.', nl:'Per AI-medewerker. 12-maanden looptijd — betaal maandelijks of jaarlijks (jaarlijks bespaart 20%). Geen extra personeel nodig; het Scale-pakket bevat een gratis laptop.' },
    ...
    'pr.custom':   { en:'Custom', de:'Individuell', nl:'Op maat' },
    ...
    'pr.q2':       { en:'Is there a minimum term?', de:'Gibt es eine Mindestlaufzeit?', nl:'Is er een minimale looptijd?' },
    'pr.a2':       { en:'Yes. All plans run for a 12-month term. You can pay monthly or yearly (yearly saves 20%), but the subscription can only be cancelled after those 12 months. The free laptop comes with the Scale plan.', de:'Ja. Alle Tarife haben eine Laufzeit von 12 Monaten. Sie können monatlich oder jährlich zahlen (jährlich spart 20%), das Abo ist jedoch erst nach diesen 12 Monaten kündbar. Der Gratis-Laptop gehört zum Scale-Tarif.', nl:'Ja. Alle abonnementen hebben een looptijd van 12 maanden. Je kunt maandelijks of jaarlijks betalen (jaarlijks bespaart 20%), maar het abonnement kan pas na die 12 maanden worden opgezegd. De gratis laptop hoort bij het Scale-pakket.' },
